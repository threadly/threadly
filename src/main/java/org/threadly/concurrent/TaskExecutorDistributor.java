...
public class TaskExecutorDistributor {
   ...
   */
  protected class RunnableFuture<T> implements ListenableFuture<T>, Runnable {
    ...
    protected RunnableFuture(Runnable task, T result) {
      this.runnable = task;
    ...
    protected RunnableFuture(Callable<T> task) {
      this.runnable = null;
