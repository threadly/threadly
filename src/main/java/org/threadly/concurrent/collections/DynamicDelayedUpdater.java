 ...
 * Threadly uses an idea of delay items which can adjust there delay time, but this must be 
...
public interface DynamicDelayedUpdater {
   ...
   * function to allow the item to update its delay before returning 
