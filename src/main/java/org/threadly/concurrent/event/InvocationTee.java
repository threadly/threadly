...
public class InvocationTee {
  ...
  public static <T> T tee(Class<? super T> teeInterface, T ... instances) {
    return setupHelper(ListenerHelper.<T>build(teeInterface), instances);
  }
  ...
  public static <T> T teeWithExecutor(Executor executor, 
    ...
    return setupHelper(DefaultExecutorListenerHelper.<T>build(teeInterface, executor), instances);
  }
